...
export async function updateSession(request: NextRequest) {
    ...
    // Public routes logic
    const publicRoutes = ['/login', '/auth/callback', '/auth/forgot-password', '/login/newPassword', '/register', '/postulacion', '/solicitar-personal', '/api/solicitudes-personal', '/decision-contrato', '/api/decision-contrato', '/decision-aumento', '/api/decision-aumento']
